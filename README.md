...
>
> Its purpose is running those pending changes on a real device before they land. When a PR is merged upstream, the next rebuild picks it up from `develop` and it stops being local.
>
...
> | Tappable end-of-book menu | [#2860](https://github.com/crosspoint-reader/crosspoint-reader/pull/2860) |
